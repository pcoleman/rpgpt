...
function craftMessage(sessionName, playerName, message) {
	...
	messageArray.push({"role":"system", "content": "You are a game master using the " + mechanics + " rules, all of your responses are formatted as JSON. Use a " + writingStyle});
