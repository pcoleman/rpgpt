	...
	input.onchange = event => { 
	  var file = event.target.files[0];
		...
		pdfToText(typedarray).then(function(result) {
			...
			var userMessage = "Create a summary of the following passage, while maintaining any details about the setting, characters, location, groups, evets, or rules. Passage: ";
